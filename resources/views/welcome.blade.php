    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">Plataforma integral para gestión de ligas de béisbol.
                </p>
                ...
                @if($leagues->count() > 0)
                <div class="mt-8 mb-4">
                    <h2 class="text-lg font-bold">Ligas Activas</h2>
                    <ul class="mt-2 space-y-2">
                        @foreach($leagues as $league)
                        <li>
                            <a href="{{ route('public.league.show', $league->slug) }}"
